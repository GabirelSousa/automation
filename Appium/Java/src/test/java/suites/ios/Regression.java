...
public class Regression extends IOSBase {
...
//    Apple wallet - Elements missing and not correctly positioned
...
//    (Only IOS) More / Change password: Password fields have inputs inserted.
